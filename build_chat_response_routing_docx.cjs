/* Build Chat_Response_Routing_Policy.docx from Chat_Response_Routing_Policy.md.
...
const MD_PATH  = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/Chat_Response_Routing_Policy.md';
const OUT_PRIMARY = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/Chat_Response_Routing_Policy.docx';
const OUT_DESKTOP = '/Users/admin/Desktop/Chat_Response_Routing_Policy.docx';
...
const doc = new Document({
  ...
  title: 'Chat Response Routing Policy',
  description: 'Response-routing policy + ~70 test cases for the YourAI dev team.',
  styles: {
    default: {
