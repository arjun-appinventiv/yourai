/* Build FRD_Knowledge_Pack.docx from FRD_Knowledge_Pack.md.
...
const SCREENSHOT_DIR = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/KnowledgePack_screens';
...
const MD_PATH  = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/FRD_Knowledge_Pack.md';
const OUT_PRIMARY = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/FRD_Knowledge_Pack.docx';
const OUT_DESKTOP = '/Users/admin/Desktop/FRD_Knowledge_Pack.docx';
...
const doc = new Document({
  ...
  title: 'FRD — Knowledge Pack',
  description: 'Functional Requirements Document for the YourAI Knowledge Pack module.',
  styles: {
    default: {
