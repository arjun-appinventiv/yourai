/* Build FRD_Workflow_Operations.docx from FRD_Workflow_Operations.md.
...
const SCREENSHOT_DIR = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/Workflow_screens';
...
const MD_PATH  = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/FRD_Workflow_Operations.md';
const OUT_PRIMARY = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/FRD_Workflow_Operations.docx';
const OUT_DESKTOP = '/Users/admin/Desktop/FRD_Workflow_Operations.docx';
...
const doc = new Document({
  ...
  title: 'FRD — Workflow_Operations',
  description: 'Functional Requirements Document for the YourAI Workflows feature.',
  styles: {
    default: {
