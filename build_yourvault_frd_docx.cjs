/* Build FRD_YourVault.docx from YourVault.md.
   Mirrors build_sprint1_frd_docx.cjs — handles headings, **bold**, *italic*,
   `code`, - bullets, | tables |, --- horizontal rules, and embeds screenshots
   via the ![[screenshot:file|caption]] marker. */
const fs = require('fs');
...
const SCREENSHOT_DIR = '/Users/admin/Desktop/yourai_frd_screenshots';
...
const MD_PATH  = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/YourVault.md';
const OUT_PRIMARY = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/FRD_YourVault.docx';
const OUT_DESKTOP = '/Users/admin/Desktop/FRD_YourVault.docx';
...
const doc = new Document({
  ...
  title: 'FRD — YourVault',
  description: 'Functional Requirements Document for the YourAI YourVault module.',
  styles: {
