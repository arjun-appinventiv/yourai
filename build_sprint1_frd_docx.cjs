/* Build FRD_Sprint_1_Tenant_Chat.docx from Sprint_1_Tenant_Chat.md.
...
const MD_PATH  = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/Sprint_1_Tenant_Chat.md';
const OUT_PRIMARY = '/Users/admin/Downloads/scope-creator-ai/.claude/worktrees/great-banach/docs/extracted/FRD_Sprint_1_Tenant_Chat.docx';
const OUT_DESKTOP = '/Users/admin/Desktop/FRD_Sprint_1_Tenant_Chat.docx';
...
const doc = new Document({
  ...
  title: 'FRD — YourAI Sprint 1: Tenant Chat',
  description: 'Functional Requirements Document for Sprint 1 of the YourAI tenant chat surface.',
  styles: {
    default: {
